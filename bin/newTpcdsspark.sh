...
check_createtables() {
  ...
  bin/spark-sql --master yarn ${EXTRA_OPTIONS} --conf spark.sql.warehouse.dir=/home/gsd --conf spark.sql.catalogImplementation=hive -f ${TPCDS_WORK_DIR}/row_counts.sql > ${TPCDS_WORK_DIR}/rowcounts.out 2>&1
