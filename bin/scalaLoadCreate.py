...
def typeMainDeriver(DBName, delimiter, colNames, rootdir):
	...
	scc = "val pw = new PrintWriter(new File(\""+rootdir+"/scalaStructs/" +  DBName[DBName.rfind("/")+1:]+".json" + "\" ))\n"
...
if __name__ == '__main__':
	...
	with open(scpath.split(".")[0] + ".scala", 'w+') as catalogFile:
		catalogFile.write(typeMainDeriver(sys.argv[1].split(".")[0], sys.argv[2], sys.argv[3], sys.argv[4]))
