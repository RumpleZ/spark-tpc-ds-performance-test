...
if __name__ == '__main__':
	if(len(sys.argv) != 3):
		print("Wrong arguments. python3 generateWorkload.py START_QUERY(1) END_QUERY(99)")
		exit(-1)
	with open("tables.txt", "r+") as tables:
		tablex = tables.readline().split(' ')[:-1]
	loadCatalog(sys.argv[1], sys.argv[2], tablex)
